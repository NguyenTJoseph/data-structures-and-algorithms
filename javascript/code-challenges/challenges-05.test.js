...
const addValues = (arr) => {
  // Solution code here...
  let added = arr.reduce((acc, curr) => {acc = acc + curr 
  return acc}, 0 )
  return added
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let added = arr.reduce((acc, curr) => {acc = acc + curr.purchasePrice 
    return acc}, 0 )
    return added
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let count = arr.reduce((acc) => {acc = acc + 1 
    return acc}, 0 )
    return count
};
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce((acc, curr) => {acc.push(curr.name)
    return acc}, [] )
    return names
};
...
const reversedString = (str) => {
  ...
  for (let index = str.length; index >= 0; index--) {
    letters.push(str.charAt(index));
  
  }
  let word = letters.reduce((acc, curr) => {acc = acc + curr
    return acc}, '' )
    return word
};
